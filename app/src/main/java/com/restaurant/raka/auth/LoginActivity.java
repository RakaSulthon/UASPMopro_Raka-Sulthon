...
import com.restaurant.raka.DashboardActivity;
import com.restaurant.raka.R;
import com.restaurant.raka.data.Session;
import com.restaurant.raka.model.LoginResponse;
import com.restaurant.raka.utils.DialogUtils;

import java.util.List;

import static com.restaurant.raka.data.Constans.LOGIN;
        ...
        AndroidNetworking.post(LOGIN)
                ...
                .getAsObject(LoginResponse.class, new ParsedRequestListener() {
                    ...
                    public void onError(ANError anError) {
                        Toast.makeText(LoginActivity.this, "Eror kesalahan API", Toast.LENGTH_SHORT).show();
                        Toast.makeText(LoginActivity.this, "Eror kesalahan API : "+anError.getCause().toString(), Toast.LENGTH_SHORT).show();
                        DialogUtils.closeDialog();
                    }
                });
    }
